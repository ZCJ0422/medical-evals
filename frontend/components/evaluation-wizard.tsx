...
export function EvaluationWizard({ datasets }: { datasets: DatasetVersion[] }) {
  ...
  async function submit() {
    ...
    const payload = { name: draft.name, target_model_id: draft.target_model_id, judge_model_id: needsJudge ? draft.judge_model_id : "", dataset_version_id: draft.dataset_version_id, rubric_id: draft.dataset_version_id, target_base_url: draft.target_base_url, target_api_key: draft.target_api_key, judge_base_url: needsJudge ? draft.judge_base_url : "", judge_api_key: needsJudge ? draft.judge_api_key : "", max_samples: draft.max_samples ? Number(draft.max_samples) : null };
    try {
